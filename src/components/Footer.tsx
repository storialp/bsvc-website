...
const navigation = {
  ...
  social: [
    ...
    {
      name: "Instagram",
      href: "https://www.instagram.com/bsvc_bocconi/",
      icon: (props: IconProps) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
...
export default function Footer() {
  return (
    <section id="footer" aria-label="What you will get with us">
      <footer className="bg-white">
        <div className="border-t border-gray-200 pt-8 lg:flex lg:items-center lg:justify-between xl:mt-0 px-6"></div>
